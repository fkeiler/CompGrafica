...
namespace CG {
    ...
    inline Material WaterTank(void) {return Material{LinearAlgebra::Vector3Df{0, 0.29804, 0.59215}, LinearAlgebra::Vector3Df{0, 0.29804, 0.59215},LinearAlgebra::Vector3Df{0, 0.29804, 0.59215}, 0.1};}
